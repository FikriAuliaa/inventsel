                ...
                <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="name" name="name" type="text"
                            ...
                            placeholder="Contoh: Ahmad Fikri" :value="old('name')" required autofocus />
                    ...
                    <div>
                        ...
                        <select id="role_id" name="role_id"
                            ...
                            required>
                            <option value="">Pilih Otoritas Sistem</option>
                    ...
                    <div class="pt-4 flex justify-end gap-3 border-t border-gray-100 dark:border-zinc-800">
                        ...
                        <button type="submit"
                            class="px-6 py-2.5 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl shadow-md transition transform active:scale-95">Daftarkan
                            User</button>
                    </div>
                </form>
            </div>
