                ...
                <div>
                    <p class="text-sm mt-2 text-gray-800 dark:text-zinc-200">
                        ...
                        <button form="send-verification"
                            class="underline text-sm text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-zinc-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
