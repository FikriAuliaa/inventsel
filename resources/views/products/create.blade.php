        ...
        <div
            ...
            <div>
                <div
                    ...
                    <span>/</span>
                    <span class="text-indigo-600 dark:text-white">Tambah</span>
                </div>
                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <input id="nama_barang" name="nama_barang" type="text" required
                            ...
                            placeholder="Contoh: Sony Alpha a6000" />
                    ...
                    <div>
                        ...
                        <input id="kode_barang" name="kode_barang" type="text" required
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-zinc-700 bg-white dark:bg-[#131314] text-gray-900 dark:text-zinc-100 focus:border-indigo-500 focus:ring focus:ring-indigo-200/50 transition text-sm font-mono placeholder-gray-400 dark:placeholder-zinc-600"
                            placeholder="Contoh: CAM-SONY-A6K" />
                    ...
                    <div>
                        ...
                        <input id="lokasi_penyimpanan" name="lokasi_penyimpanan" type="text" required
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-zinc-700 bg-white dark:bg-[#131314] text-gray-900 dark:text-zinc-100 focus:border-indigo-500 focus:ring focus:ring-indigo-200/50 transition text-sm placeholder-gray-400 dark:placeholder-zinc-600"
                            placeholder="Contoh: Lemari Studio A" />
